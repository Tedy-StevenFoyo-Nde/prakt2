...
public class BuergeraemterView {
    ...
    public BuergeraemterView(Stage primaryStage)
    {
		...
		this.initListener();
    	this.model = new BuergeraemterModel();
    	this.control = new BuergeraemterControl(this, this.model);
    }
   ...
   private void initListener() {
    ...
    public void zeigeFehlerMeldungAn(String message)
    {
    ...
    {
    	this.control.schreibeBuergeraemterInDatei(typ);
    }
}
